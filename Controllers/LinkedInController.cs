...
namespace TeacherWebsiteBackEnd.Controllers
{
    ...
    public class LinkedInController : Controller
    {
        ...
        public async Task<ActionResult<string>> GetLinkedInProfileInformation(string accessToken)
        {
        ...
        public async Task<ActionResult<string>> GetLinkedInEmail(string accessToken)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<LinkedInAccessTokenResponse>> GetLinkedInAccessToken([FromBody] AccessTokenRequest accessTokenRequest)
        {
